...
notes:
  ...
  - "System key: C(config_template_id) — server-assigned, resolved automatically from gathered state."
  - "Users do not need to provide C(config_template_id) unless disambiguating duplicate names."
