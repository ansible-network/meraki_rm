...
notes:
  ...
  - "System key: C(interface_id) — server-assigned, resolved automatically from gathered state."
  - "Users do not need to provide C(interface_id) unless disambiguating duplicate names."
