"""Generated API dataclass for Meraki switch switch_stack.
...
@dataclass
class SwitchStack:
    """Meraki switch switch_stack API schema.
    ...
    isMonitorOnly: Optional[bool] = None
