"""Drift-detection tests for generated MqttBroker dataclass."""
...
class TestSchema:
    """MqttBroker field inventory — catches regeneration drift."""

    def test_is_dataclass(self):
        assert is_dataclass(mqtt_broker.MqttBroker)

    def test_expected_fields_exist(self):
        field_names = {f.name for f in dc_fields(mqtt_broker.MqttBroker())}
        expected = {'id', 'port', 'authentication', 'name', 'security', 'host'}
