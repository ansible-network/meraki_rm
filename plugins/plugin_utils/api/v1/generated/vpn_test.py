"""Drift-detection tests for generated Vpn dataclass."""
...
class TestSchema:
    """Vpn field inventory — catches regeneration drift."""

    def test_is_dataclass(self):
        assert is_dataclass(vpn.Vpn)

    def test_expected_fields_exist(self):
        field_names = {f.name for f in dc_fields(vpn.Vpn())}
        expected = {'enabled', 'asNumber', 'hubs', 'mode', 'neighbors', 'subnets', 'ibgpHoldTimer', 'subnet'}
